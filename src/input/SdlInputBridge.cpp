...
) noexcept
{
    ...
    setKey(PhysicalControl::KeyCameraShoulder, SDL_SCANCODE_TAB);
    ...
    setKey(PhysicalControl::KeyTerminalUse, SDL_SCANCODE_T);
    setKey(PhysicalControl::KeyCardSuite, SDL_SCANCODE_G);
    setKey(PhysicalControl::KeyBet, SDL_SCANCODE_B);
    setKey(PhysicalControl::KeyCardHit, SDL_SCANCODE_H);
    setKey(PhysicalControl::KeyCardStand, SDL_SCANCODE_J);
    setKey(PhysicalControl::KeyInspect, SDL_SCANCODE_I);
...
PhysicalControl SdlInputBridge::keyboardControl(SDL_Scancode scancode) noexcept
{
    switch (scancode) {
        ...
        case SDL_SCANCODE_TAB: return PhysicalControl::KeyCameraShoulder;
        ...
        case SDL_SCANCODE_T: return PhysicalControl::KeyTerminalUse;
        case SDL_SCANCODE_G: return PhysicalControl::KeyCardSuite;
        case SDL_SCANCODE_B: return PhysicalControl::KeyBet;
        case SDL_SCANCODE_H: return PhysicalControl::KeyCardHit;
        case SDL_SCANCODE_J: return PhysicalControl::KeyCardStand;
        case SDL_SCANCODE_I: return PhysicalControl::KeyInspect;
